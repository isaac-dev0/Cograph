...
@Module({
  ...
  providers: [AnalysisService, AnalysisResolver, MCPAnalysisService, Neo4jGraphService, GraphQueryService],
  exports: [AnalysisService, Neo4jGraphService, GraphQueryService],
})
